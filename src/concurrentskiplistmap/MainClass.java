...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// constructor
		ConcurrentSkipListMap<String, Long> oceaniaCountriesPopulation = new ConcurrentSkipListMap<>();
		...
		// putAll
		ConcurrentSkipListMap<String, Long> moreOceanCountries = new ConcurrentSkipListMap<>();
		...
		// computeIfPresent
		oceaniaCountriesPopulation.computeIfPresent("Micronesia", (key, val) -> (val < 100000L) ? 50000L : val);
		System.out.println(oceaniaCountriesPopulation);
		...
		// headMap
		ConcurrentNavigableMap<String, Long> headMap = oceaniaCountriesPopulation.headMap("Papua New Guinea");
		System.out.println("Oceania Countries Population Head Map: " + headMap);

		// subMap
		ConcurrentNavigableMap<String, Long> subMap = oceaniaCountriesPopulation.subMap("Fiji", "Vanuatu");
		...
		// tailMap
		ConcurrentNavigableMap<String, Long> tailMap = oceaniaCountriesPopulation.tailMap("Papua New Guinea");
